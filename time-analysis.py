...
# plt.ylabel('variance of RTT',fontsize=14)
# # plt.legend(bbox_to_anchor=(0,1,0.6,0), loc="lower left", mode="expand", ncol=3,fontsize=14,frameon=False)
...
# Create a subplot with specified height
...
ax.set_ylabel('variance of RTT', fontsize=14)
