...
# ssh node001 "/var/scratch/esu530/entities/entities.x86_64 -batchmode -nographics -logStats true -statsFile /var/scratch/esu530/server_log.csv -playType Server > ./unity-net-benchmark/server_logs/server_output.log 2>&1 &" &
sleep 5

server_pid=$(ssh $server_node "pgrep entities.x86_64")
# ssh node001 "pgrep /var/scratch/esu530/entities/entities.x86_64"
...
sleep 2
ssh $client_node "pkill -0 -f entities.x86_64" && ssh $client_node "pkill -9 -f entities.x86_64"
